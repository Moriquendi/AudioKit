...
public class Expander: NamedNode {
    ...
    public var compressionAmount: AUValue {
        return avAudioNode.akAUAudioUnit.parameterTree?.allParameters[7].value ?? 0
    }

    /// Input Amplitude (dB) read only
    public var inputAmplitude: AUValue {
        return avAudioNode.akAUAudioUnit.parameterTree?.allParameters[8].value ?? 0
    }

    /// Output Amplitude (dB) read only
    public var outputAmplitude: AUValue {
        return avAudioNode.akAUAudioUnit.parameterTree?.allParameters[9].value ?? 0
    }
